...
export const translations = {
  en: {
    ...
    'guide.title':'Route technique guide','guide.pageLabel':'Route technique guide. {techniques}','pdf.credits':'created with hike-generator by Wouter van der Ven','pdf.page':'PAGE {page} / {pages}','pdf.noSteps':'Add a step before downloading.',
  ...
  nl: {
    ...
    'guide.title':'Uitleg routetechnieken','guide.pageLabel':'Uitleg routetechnieken. {techniques}','pdf.credits':'Gemaakt met https://vandervenwouter.github.io/hike-generator','pdf.page':'PAGINA {page} / {pages}','pdf.noSteps':'Voeg een stap toe voordat je downloadt.',
...
translations.en['guide.junction']='Enter the junction at the dot and follow the arrow to the correct exit.';
translations.en['guide.dot-arrow']='Follow the line from the dot to the arrow. Read it relative to your walking direction: up means straight ahead.';
translations.en['guide.eyes']='Walk in the direction the eyes are looking. Read it relative to your walking direction: looking up means straight ahead, looking down means turn back.';
translations.en['guide.compass']='Follow the given compass bearing. 0° is north, 90° east, 180° south and 270° west.';
translations.en['guide.clock']='First draw the clock hands for the given time. Point the short hand north; the long hand shows your walking direction.';
translations.en['guide.fraction']='The numerator selects the road; the denominator is the total number of roads. Include the road you arrived on and count from left to right.';
translations.en['guide.quiz']='Answer the question. The first road on your left is A; continue clockwise with B, C, D, etc. Take the road matching your answer. Count the road you arrived on last.';
translations.en['guide.photo']='Use a photo as the route instruction.';
...
translations.nl['guide.junction']='Kom bij de stip het kruispunt op en volg de pijl naar de juiste uitgang.';
translations.nl['guide.dot-arrow']='Volg de lijn vanaf het bolletje naar de pijl. Lees de richting vanuit je looprichting: omhoog is rechtdoor.';
translations.nl['guide.eyes']='Loop in de richting waarin de ogen kijken, vanuit je eigen looprichting. Omhoog kijken betekent rechtdoor; omlaag kijken betekent terug.';
translations.nl['guide.compass']='Loop in de aangegeven kompasrichting. 0° is noord, 90° oost, 180° zuid en 270° west.';
translations.nl['guide.clock']='Teken eerst zelf de wijzers bij de gegeven tijd. Richt de kleine wijzer naar het noorden; de grote wijzer geeft je looprichting aan.';
translations.nl['guide.fraction']='De teller geeft aan welke weg je neemt; de noemer is het totale aantal wegen. Tel de aankomstweg mee en tel van links naar rechts.';
translations.nl['guide.quiz']='Beantwoord de vraag. De eerste weg aan je linkerhand is A; ga met de klok mee verder met B, C, D, enz. Neem de weg van jouw antwoord. De aankomstweg telt als laatste mee.';
translations.nl['guide.photo']='Gebruik een foto als route-instructie.';
...
translations.nl['stripkaart.left']='Wegen links';
translations.nl['stripkaart.right']='Wegen rechts';

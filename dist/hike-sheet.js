...
export const translations = {
  en: {
    ...
    'group.Angled side road': 'Angled side road',
    'group.Angled T-junction': 'Angled T-junction',
    'group.Skewed crossroads': 'Skewed crossroads',

    'technique.clock': 'Clock',
    'time': 'Time',
    'technique.quiz': 'Quiz question',
    'technique.input': 'Free text',
    'technique.photo': 'Photo',
    'input.value': 'Text',
    'step.numbered': 'Count in step numbering',
    'step.unnumbered': 'without a number',
    'input.placeholder': 'e.g. cross the zebra crossing',
    'photo.file': 'Choose a PNG or JPG photo',
    'photo.change': 'Replace photo',
    'photo.width': 'Width in PDF',
    'photo.fullWidth': 'full width',
    'photo.placeholder': 'Choose a PNG or JPG photo',
    'photo.invalid': 'Choose a PNG or JPG photo.',
    'quiz.question': 'Question',
    'quiz.questionPlaceholder': 'e.g. How many legs does a spider have?',
    'quiz.answer': 'Answer {letter}',
    'quiz.addAnswer': 'Add answer',
    'quiz.removeAnswer': 'Remove answer {letter}',
    'quiz.answers': '{count} answers',
    'quiz.required': 'Enter a question and fill in every answer.',

    'meta.title': 'hike-generator',
    'meta.description':
      'Build a hike one intersection at a time. Create clear, illustrated instructions and print your hike on A4.',

    'brand.builder': 'HIKE BUILDER',
    'language': 'Language',
    'undo': 'Undo',
    'newHike': 'New hike',
    'newHikeLimit': 'You can keep up to three local hikes.',
    'importHikeLimit': 'You can keep up to three local hikes. Delete one before importing another.',
    'hikeSlot': 'Hike {number}',
    'deleteHike': 'Delete hike',
    'deleteHikeConfirm': 'Delete hike "{hikeTitle}"?',
    'resetHikeConfirm': 'Delete hike "{hikeTitle}" and start a new one?',
    'exportHike': 'Export hike as JSON',
    'importHike': 'Import hike as JSON',
    'hikeExported': 'Hike file downloaded',
    'hikeImported': 'Hike imported',
    'hikeImportFailed': 'Could not import hike. {error}',
    'downloadPdf': 'Download PDF',
    'preparingPdf': 'Preparing PDF…',

    'building.title': 'Add step',
    'addHikeItem': 'Add step',
    'insertHikeItem': 'Add step after step {number}',
    'insertHikeItemBefore': 'Add step before step {number}',
    'close': 'Close',
    'technique': 'Route technique',
    'technique.junction': 'Situation sketch',
    'technique.compass': 'Compass bearing',
    'technique.fraction': 'Fractions',
    'technique.dot-arrow': 'Dot and arrow',
    'technique.eyes': 'Eyes',
    'element.Hairpin left': 'Hairpin left',
    'element.Hairpin right': 'Hairpin right',
    'element.S-bend left': 'S-bend left',
    'element.S-bend right': 'S-bend right',
    'direction.0': 'Go straight',
    'direction.45': 'Slight right',
    'direction.90': 'Turn right',
    'direction.135': 'Hard right',
    'direction.180': 'Turn back',
    'direction.225': 'Hard left',
    'direction.270': 'Turn left',
    'direction.315': 'Slight left',
    'bearing': 'Bearing',
    'bearingLabel': 'Bearing for step {number} in degrees',
    'numerator': 'Numerator',
    'denominator': 'Denominator',
    'fractionLabel': 'Fraction for step {number}',
    'addCompass': 'Add',
    'roadCount': 'Number of roads',
    'roadCountOption': '{count} roads',
    'roadLayout': 'Road layout',
    'junctionShape': 'Junction shape',
    'hikeExit': 'Choose the road to take',
    'direction': 'Your direction',
    'roadEdges': 'Road edges',
    'approachHelp': 'The dot marks where you enter the junction. Follow the arrow to your exit.',

    'hikeName': 'Hike name',
    'untitled': 'Hike 1',
    'distancePrompt': 'Add distances as you go',
    'start': 'START',
    'startPlaceholder': 'Start note',
    'finish': 'FINISH',
    'finishPlaceholder': 'Finish note',

    'printPreview': 'Print preview A4',
    'pdfOptions': 'PDF options',
    'includeTechniqueGuide': 'Explain route techniques',
    'printNote': 'Six consistent diagrams per A4 sheet. Numbered automatically, ready to print.',
    'printableHike': 'Printable hike',
    'intersectionLibrary': 'Step library',
    'hikeEditor': 'Hike editor',

    'step': 'step',
    'steps': 'steps',
    'page': 'page',
    'pages': 'pages',
    'distanceTotal': '{distance} m of noted distances',
    'added': 'Step {number} added',
    'duplicated': 'Step {number} duplicated',
    'removed': 'Step removed.',
    'undone': 'Last change undone',
    'newReady': 'New hike started.',
    'newConfirm': 'Start a new hike? The current hike will be removed.',
    'duplicateConfirm': 'Are you sure you want to duplicate step {number}?',
    'removeConfirm': 'Are you sure you want to remove step {number}?',
    'pdfReady': 'Your A4 hike sheet is ready',
    'pdfFailed': 'Could not create the PDF. {error}',
    'saveFailed': 'Your browser could not save this draft. Download your PDF before leaving.',
    'loadFailed': 'The saved draft could not be loaded. This hike is temporary.',
    'stepLimit': 'A hike can contain up to 300 steps.',

    'moveUp': 'Move step {number} up',
    'moveDown': 'Move step {number} down',
    'duplicateStep': 'Duplicate step {number}',
    'removeStep': 'Remove step {number}',
    'distance': 'Distance (m)',
    'distancePlaceholder': 'e.g. 200',
    'distanceLabel': 'Distance to step {number} in metres',
    'note': 'Landmark or note',
    'notePlaceholder': 'e.g. Cross at the zebra crossing',
    'noteLabel': 'Note for step {number}',

    'rotateLeft': 'Rotate step {number} counterclockwise by 45 degrees',
    'rotateRight': 'Rotate step {number} clockwise by 45 degrees',
    'rotation': 'Rotation {degrees} degrees',
    'rotateLeftTitle': 'Rotate 45° counterclockwise',
    'rotateRightTitle': 'Rotate 45° clockwise',

    'roadTypes': 'Road types',
    'faintPath': 'Faint path',
    'markFaintPath': 'Mark {road} as a faint path',
    'landmarks': 'Landmarks',
    'add': 'Add',
    'item': 'Item',
    'roadArm': 'Road arm',
    'position': 'Position',
    'side.left': 'Left side of road',
    'side.right': 'Right side of road',
    'itemLabel': 'Item for landmark {landmark} on step {step}',
    'armLabel': 'Road arm for landmark {landmark} on step {step}',
    'positionLabel': 'Position for landmark {landmark} on step {step}',
    'removeLandmark': 'Remove landmark {landmark} from step {step}',
    'addLandmark': 'Add landmark',

    'guide.title': 'Route technique guide',
    'guide.pageLabel': 'Route technique guide. {techniques}',
    'pdf.credits': 'created with hike-generator by Wouter van der Ven',
    'pdf.page': 'PAGE {page} / {pages}',
    'pdf.noSteps': 'Add a step before downloading.',

    'group.T-junction': 'T-junction',
    'group.Crossroads': 'Crossroads',
    'group.Fork': 'Fork',
    'group.Side road': 'Side road',
    'group.Bends & paths': 'Bends & paths',
    'group.4-way intersection': '4-way intersection',
    'group.Three-way fork': 'Three-way fork',
    'group.5-way intersection': '5-way intersection',
    'group.6-way intersection': '6-way intersection',

    'element.Turn left': 'Turn left',
    'element.Turn right': 'Turn right',
    'element.Go straight': 'Go straight',
    'element.Go straight 45° right': 'Go straight 45° right',
    'element.Go straight 45° left': 'Go straight 45° left',
    'element.Keep left': 'Keep left',
    'element.Keep right': 'Keep right',
    'element.Pass left road': 'Pass left road',
    'element.Pass right road': 'Pass right road',
    'element.Bend left': 'Bend left',
    'element.Bend right': 'Bend right',
    'element.First road right': 'First road right',
    'element.Second road right': 'Second road right',
    'element.First road left': 'First road left',
    'element.Second road left': 'Second road left',
    'element.Hard right': 'Hard right',
    'element.Slight right': 'Slight right',
    'element.Slight left': 'Slight left',
    'element.Hard left': 'Hard left',

    'landmark.bridge': 'Bridge',
    'landmark.parking': 'Parking area',
    'landmark.bridleway': 'Bridleway',
    'landmark.water': 'Body of water',

    'arm.Right': 'Right road',
    'arm.Lower-right': 'Lower-right road',
    'arm.Bottom': 'Bottom road',
    'arm.Lower-left': 'Lower-left road',
    'arm.Left': 'Left road',
    'arm.Upper-left': 'Upper-left road',
    'arm.Top': 'Top road',
    'arm.Upper-right': 'Upper-right road',
    'arm.entry': ' (entry)',

    'previewLabel': 'A4 page {page} of {pages}. {steps}',

    'guide.junction': 'Enter the junction at the dot and follow the arrow to the correct exit.',
    'guide.dot-arrow':
      'Follow the line from the dot to the arrow. Read it relative to your walking direction: up means straight ahead.',
    'guide.eyes':
      'Walk in the direction the eyes are looking. Read it relative to your walking direction: looking up means straight ahead, looking down means turn back.',
    'guide.compass':
      'Follow the given compass bearing. 0° is north, 90° east, 180° south and 270° west.',
    'guide.clock':
      'First draw the clock hands for the given time. Point the short hand north; the long hand shows your walking direction.',
    'guide.fraction':
      'The numerator selects the road; the denominator is the total number of roads. Include the road you arrived on and count from left to right.',
    'guide.quiz':
      'Answer the question. The first road on your left is A; continue clockwise with B, C, D, etc. Take the road matching your answer. Count the road you arrived on last.',
    'guide.photo': 'Use a photo as the route instruction.',
    'technique.stripkaart': 'Stripkaart',
    'guide.stripkaart':
      'Start at the dot and follow the vertical route line upward. Leave every marked side road on its side. A dashed side road is a faint path.',
    'stripkaart.left': 'Left side roads',
    'stripkaart.right': 'Right side roads',
    'stripkaart.leftRoad': 'Left road {number}',
    'stripkaart.rightRoad': 'Right road {number}',
    'stripkaart.points': '{count} points',
    'stripkaart.add': 'Add point',
    'stripkaart.remove': 'Remove point',
    'stripkaart.endMarker': 'End marking',
    'stripkaart.endMarker.arrow': 'Arrowhead',
    'stripkaart.endMarker.none': 'No end marking',
    'stripkaart.endMarker.bar': 'Wide horizontal line',
  },
  nl: {
    'arm.Centre': 'Midden van de weg',
    'element.Turn back': 'Omkeren',
    'group.Angled side road': 'Schuine zijweg',
    'group.Angled T-junction': 'Schuine T-splitsing',
    'group.Skewed crossroads': 'Schuin kruispunt',

    'technique.clock': 'Klok',
    'time': 'Tijd',
    'technique.quiz': 'Quizvraag',
    'technique.input': 'Vrije tekst',
    'technique.photo': 'Foto',
    'input.value': 'Tekst',
    'step.numbered': 'Meetellen in stapnummering',
    'step.unnumbered': 'zonder nummer',
    'input.placeholder': 'bijv. steek het zebrapad over',
    'photo.file': 'Kies een PNG- of JPG-foto',
    'photo.change': 'Foto vervangen',
    'photo.width': 'Breedte in PDF',
    'photo.fullWidth': 'volledige breedte',
    'photo.placeholder': 'Kies een PNG- of JPG-foto',
    'photo.invalid': 'Kies een PNG- of JPG-foto.',
    'quiz.question': 'Vraag',
    'quiz.questionPlaceholder': 'bijv. Hoeveel poten heeft een spin?',
    'quiz.answer': 'Antwoord {letter}',
    'quiz.addAnswer': 'Antwoord toevoegen',
    'quiz.removeAnswer': 'Antwoord {letter} verwijderen',
    'quiz.answers': '{count} antwoorden',
    'quiz.required': 'Vul de vraag en alle antwoorden in.',

    'meta.title': 'hike-generator',
    'meta.description':
      'Bouw stap voor stap een hike met duidelijke kruispunttekeningen en print deze op A4.',

    'brand.builder': 'HIKEBOUWER',
    'language': 'Taal',
    'undo': 'Ongedaan maken',
    'newHike': 'Nieuwe hike',
    'newHikeLimit': 'Je kunt maximaal drie lokale hikes bewaren.',
    'importHikeLimit':
      'Je kunt maximaal drie lokale hikes bewaren. Verwijder eerst een hike voordat je een andere importeert.',
    'hikeSlot': 'Hike {number}',
    'deleteHike': 'Hike verwijderen',
    'deleteHikeConfirm': 'Hike "{hikeTitle}" verwijderen?',
    'resetHikeConfirm': 'Hike "{hikeTitle}" verwijderen en een nieuwe starten?',
    'exportHike': 'Hike exporteren als JSON',
    'importHike': 'Hike importeren als JSON',
    'hikeExported': 'Hikebestand gedownload',
    'hikeImported': 'Hike geïmporteerd',
    'hikeImportFailed': 'Hike kon niet worden geïmporteerd. {error}',
    'downloadPdf': 'PDF downloaden',
    'preparingPdf': 'PDF voorbereiden…',

    'building.title': 'Stap toevoegen',
    'addHikeItem': 'Stap toevoegen',
    'insertHikeItem': 'Stap toevoegen na stap {number}',
    'insertHikeItemBefore': 'Stap toevoegen vóór stap {number}',
    'close': 'Sluiten',
    'technique': 'Routetechniek',
    'technique.junction': 'Kruispunten',
    'technique.compass': 'Graden schieten',
    'technique.fraction': 'Breuken',
    'technique.dot-arrow': 'Bolletje-pijltje',
    'technique.eyes': 'Oogjes',
    'element.Hairpin left': 'Haarspeld links',
    'element.Hairpin right': 'Haarspeld rechts',
    'element.S-bend left': 'S-bocht links',
    'element.S-bend right': 'S-bocht rechts',
    'direction.0': 'Rechtdoor',
    'direction.45': 'Schuin rechts',
    'direction.90': 'Rechtsaf',
    'direction.135': 'Scherp rechts',
    'direction.180': 'Terug',
    'direction.225': 'Scherp links',
    'direction.270': 'Linksaf',
    'direction.315': 'Schuin links',
    'bearing': 'Koers in graden',
    'bearingLabel': 'Koers van stap {number} in graden',
    'numerator': 'Teller',
    'denominator': 'Noemer',
    'fractionLabel': 'Breuk bij stap {number}',
    'addCompass': 'Toevoegen',
    'roadCount': 'Aantal wegen',
    'roadCountOption': '{count} wegen',
    'roadLayout': 'Weg-layout',
    'junctionShape': 'Kruispuntvorm',
    'hikeExit': 'Te nemen weg',
    'direction': 'Jouw richting',
    'roadEdges': 'Wegkanten',
    'approachHelp': 'De stip geeft aan waar je het kruispunt opkomt. Volg de pijl naar de uitgang.',

    'hikeName': 'Hikenaam',
    'untitled': 'Hike 1',
    'distancePrompt': 'Voeg desgewenst afstanden toe',
    'start': 'START',
    'startPlaceholder': 'Opmerking bij het startpunt',
    'finish': 'EIND',
    'finishPlaceholder': 'Opmerking bij het eindpunt',

    'printPreview': 'Afdrukvoorbeeld A4',
    'pdfOptions': 'PDF-opties',
    'includeTechniqueGuide': 'Uitleg routetechnieken',
    'printNote': 'Zes consistente tekeningen per A4. Automatisch genummerd en klaar om te printen.',
    'printableHike': 'Printbare hike',
    'intersectionLibrary': 'Stappenbibliotheek',
    'hikeEditor': 'Hikebewerker',

    'step': 'stap',
    'steps': 'stappen',
    'page': 'pagina',
    'pages': 'pagina’s',
    'distanceTotal': '{distance} m aan opgegeven afstanden',
    'added': 'Stap {number} toegevoegd',
    'duplicated': 'Stap {number} gedupliceerd',
    'removed': 'Stap verwijderd.',
    'undone': 'Laatste wijziging ongedaan gemaakt',
    'newReady': 'Nieuwe hike gestart.',
    'newConfirm': 'Nieuwe hike starten? De huidige hike wordt verwijderd.',
    'duplicateConfirm': 'Weet je zeker dat je stap {number} wilt dupliceren?',
    'removeConfirm': 'Weet je zeker dat je stap {number} wilt verwijderen?',
    'pdfReady': 'Je A4-hikeblad is klaar',
    'pdfFailed': 'De PDF kon niet worden gemaakt. {error}',
    'saveFailed':
      'Je browser kon dit concept niet opslaan. Download je PDF voordat je de pagina verlaat.',
    'loadFailed': 'Het opgeslagen concept kon niet worden geladen. Deze hike is tijdelijk.',
    'stepLimit': 'Een hike kan maximaal 300 stappen bevatten.',

    'moveUp': 'Verplaats stap {number} omhoog',
    'moveDown': 'Verplaats stap {number} omlaag',
    'duplicateStep': 'Dupliceer stap {number}',
    'removeStep': 'Verwijder stap {number}',
    'distance': 'Afstand (m)',
    'distancePlaceholder': 'bijv. 200',
    'distanceLabel': 'Afstand tot stap {number} in meters',
    'note': 'Opmerking',
    'notePlaceholder': 'bijv. Oversteken via het zebrapad',
    'noteLabel': 'Opmerking bij stap {number}',

    'rotateLeft': 'Draai stap {number} 45 graden linksom',
    'rotateRight': 'Draai stap {number} 45 graden rechtsom',
    'rotation': 'Draaiing {degrees} graden',
    'rotateLeftTitle': 'Draai 45° linksom',
    'rotateRightTitle': 'Draai 45° rechtsom',

    'roadTypes': 'Wegtypen',
    'faintPath': 'Hazenpaadje',
    'markFaintPath': 'Markeer {road} als hazenpaadje',
    'landmarks': 'Route-elementen',
    'add': 'Toevoegen',
    'item': 'Element',
    'roadArm': 'Wegtak',
    'position': 'Plaatsing',
    'side.left': 'Links van de weg',
    'side.right': 'Rechts van de weg',
    'itemLabel': 'Element {landmark} bij stap {step}',
    'armLabel': 'Wegtak voor element {landmark} bij stap {step}',
    'positionLabel': 'Plaatsing van element {landmark} bij stap {step}',
    'removeLandmark': 'Verwijder element {landmark} van stap {step}',
    'addLandmark': 'Element toevoegen',

    'guide.title': 'Uitleg routetechnieken',
    'guide.pageLabel': 'Uitleg routetechnieken. {techniques}',
    'pdf.credits': 'Gemaakt met https://vandervenwouter.github.io/hike-generator',
    'pdf.page': 'PAGINA {page} / {pages}',
    'pdf.noSteps': 'Voeg een stap toe voordat je downloadt.',

    'group.T-junction': 'T-splitsing',
    'group.Crossroads': 'Kruispunt',
    'group.Fork': 'Vorksplitsing',
    'group.Side road': 'Zijweg',
    'group.Bends & paths': 'Bochten en paden',
    'group.4-way intersection': 'Viersprong',
    'group.Three-way fork': 'Drievoudige vorksplitsing',
    'group.5-way intersection': 'Vijfsprong',
    'group.6-way intersection': 'Zessprong',

    'element.Turn left': 'Linksaf',
    'element.Turn right': 'Rechtsaf',
    'element.Go straight': 'Rechtdoor',
    'element.Go straight 45° right': 'Rechtdoor, 45° rechts',
    'element.Go straight 45° left': 'Rechtdoor, 45° links',
    'element.Keep left': 'Links aanhouden',
    'element.Keep right': 'Rechts aanhouden',
    'element.Pass left road': 'Linkerzijweg voorbij',
    'element.Pass right road': 'Rechterzijweg voorbij',
    'element.Bend left': 'Bocht naar links',
    'element.Bend right': 'Bocht naar rechts',
    'element.First road right': 'Eerste weg rechts',
    'element.Second road right': 'Tweede weg rechts',
    'element.First road left': 'Eerste weg links',
    'element.Second road left': 'Tweede weg links',
    'element.Hard right': 'Scherp rechts',
    'element.Slight right': 'Schuin rechts',
    'element.Slight left': 'Schuin links',
    'element.Hard left': 'Scherp links',

    'landmark.bridge': 'Brug',
    'landmark.parking': 'Parkeerplaats',
    'landmark.bridleway': 'Ruiterpad',
    'landmark.water': 'Water',

    'arm.Right': 'Rechterweg',
    'arm.Lower-right': 'Weg rechtsonder',
    'arm.Bottom': 'Onderste weg',
    'arm.Lower-left': 'Weg linksonder',
    'arm.Left': 'Linkerweg',
    'arm.Upper-left': 'Weg linksboven',
    'arm.Top': 'Bovenste weg',
    'arm.Upper-right': 'Weg rechtsboven',
    'arm.entry': ' (ingang)',

    'previewLabel': 'A4-pagina {page} van {pages}. {steps}',

    'guide.junction': 'Kom bij de stip het kruispunt op en volg de pijl naar de juiste uitgang.',
    'guide.dot-arrow':
      'Volg de lijn vanaf het bolletje naar de pijl. Lees de richting vanuit je looprichting: omhoog is rechtdoor.',
    'guide.eyes':
      'Loop in de richting waarin de ogen kijken, vanuit je eigen looprichting. Omhoog kijken betekent rechtdoor; omlaag kijken betekent terug.',
    'guide.compass':
      'Loop in de aangegeven kompasrichting. 0° is noord, 90° oost, 180° zuid en 270° west.',
    'guide.clock':
      'Teken eerst zelf de wijzers bij de gegeven tijd. Richt de kleine wijzer naar het noorden; de grote wijzer geeft je looprichting aan.',
    'guide.fraction':
      'De teller geeft aan welke weg je neemt; de noemer is het totale aantal wegen. Tel de aankomstweg mee en tel van links naar rechts.',
    'guide.quiz':
      'Beantwoord de vraag. De eerste weg aan je linkerhand is A; ga met de klok mee verder met B, C, D, enz. Neem de weg van jouw antwoord. De aankomstweg telt als laatste mee.',
    'guide.photo': 'Gebruik een foto als route-instructie.',
    'technique.stripkaart': 'Stripkaart',
    'guide.stripkaart':
      'Begin bij de stip en volg de verticale routelijn omhoog. Laat iedere gemarkeerde zijweg aan die kant liggen. Een gestreepte zijweg is een hazenpaadje.',
    'stripkaart.left': 'Wegen links',
    'stripkaart.right': 'Wegen rechts',
    'stripkaart.leftRoad': 'Linkerzijweg {number}',
    'stripkaart.rightRoad': 'Rechterzijweg {number}',
    'stripkaart.points': '{count} punten',
    'stripkaart.add': 'Splitsing toevoegen',
    'stripkaart.remove': 'Punt verwijderen',
    'stripkaart.endMarker': 'Eindmarkering',
    'stripkaart.endMarker.arrow': 'Pijlkop',
    'stripkaart.endMarker.none': 'Geen eindmarkering',
    'stripkaart.endMarker.bar': 'Brede horizontale lijn',
  },
};

...
export const translations = {
  en: {
    ...
    'editor.tip':'Notes are optional. Leave them empty for a simple diagram route.',
    'printPreview':'Print preview A4','pdfOptions':'PDF options','includeTechniqueGuide':'Explain route techniques','includeCredits':'Credits','printNote':'Six consistent diagrams per A4 sheet. Numbered automatically, ready to print.','printableRoute':'Printable route','intersectionLibrary':'Step library','routeEditor':'Route editor',
    'step':'step','steps':'steps','page':'page','pages':'pages','distanceTotal':'{distance} m of noted distances','added':'Step {number} added','duplicated':'Step {number} duplicated','removed':'Step removed. Use Undo to restore it.','undone':'Last change undone','newReady':'New route ready. Use Undo to restore your previous route.','newConfirm':'Start a new route? The current route will be removed.','pdfReady':'Your A4 route sheet is ready','pdfFailed':'Could not create the PDF. {error}','saveFailed':'Your browser could not save this draft. Download your PDF before leaving.','loadFailed':'The saved draft could not be loaded. This route is temporary.','stepLimit':'A route can contain up to 300 steps.',
  ...
  nl: {
    ...
    'editor.tip':'Opmerkingen zijn optioneel. Laat ze leeg voor een eenvoudige route met alleen tekeningen.',
    'printPreview':'Afdrukvoorbeeld A4','pdfOptions':'PDF-opties','includeTechniqueGuide':'Uitleg routetechnieken','includeCredits':'Credits','printNote':'Zes consistente tekeningen per A4. Automatisch genummerd en klaar om te printen.','printableRoute':'Printbare route','intersectionLibrary':'Stappenbibliotheek','routeEditor':'Routebewerker',
    'step':'stap','steps':'stappen','page':'pagina','pages':'pagina’s','distanceTotal':'{distance} m aan opgegeven afstanden','added':'Stap {number} toegevoegd','duplicated':'Stap {number} gedupliceerd','removed':'Stap verwijderd. Gebruik Ongedaan maken om deze te herstellen.','undone':'Laatste wijziging ongedaan gemaakt','newReady':'Nieuwe route klaar. Gebruik Ongedaan maken om je vorige route te herstellen.','newConfirm':'Nieuwe route starten? De huidige route wordt verwijderd.','pdfReady':'Je A4-routeblad is klaar','pdfFailed':'De PDF kon niet worden gemaakt. {error}','saveFailed':'Je browser kon dit concept niet opslaan. Download je PDF voordat je de pagina verlaat.','loadFailed':'Het opgeslagen concept kon niet worden geladen. Deze route is tijdelijk.','stepLimit':'Een route kan maximaal 300 stappen bevatten.',
